...
import net.nashat.ideal.DisseminationFunction.Companion.solveIncreasingFunc
import net.nashat.mbitsPerSecond
...
//    val latency = 1.seconds * latencyRounds
    ...
    val simpleDisseminationFunction =
        createDissemitationFunction(SimpleRoundBasedActiveNodeCountFunc.Companion::setupActiveNodesFunction)

    val preciseDisseminationFunction =
        createDissemitationFunction(PreciseActiveNodesFunction.Companion::setupActiveNodesFunction)

    val integralDisseminationFunction =
        createDissemitationFunction(IntegralActiveNodesFunction.Companion::setupActiveNodesFunction)
    ...
    for (t in times) {
        fun Double.deliverPercentString() = (this * 100 / totalDeliverTarget).toString()
